import svgPaths from "./svg-lr00ve91ym";
...
function List() {
  return (
    <div className="absolute left-[4px] size-[20px] top-[4px]" data-name="list">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="list">
          <path d={svgPaths.p2292ee40} fill="var(--fill-0, #8B5CF6)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame() {
  return (
    <div className="absolute bg-[#dfd8fd] left-[39px] rounded-[21px] size-[28px] top-[4px]">
      <List />
    </div>
  );
}
...
function NameCompanyHeader() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[500px]" data-name="Name/Company Header">
      <p className="css-4hzbpn flex-[1_0_0] font-['Raleway:Medium',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[#3c3c3c] text-[14px]">Event Name</p>
    </div>
  );
}
...
function AppListHeader() {
  return (
    <div className="bg-[#f1f5f9] relative rounded-[8px] shrink-0 w-full" data-name="App List Header">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[16px] items-center px-[16px] py-[8px] relative w-full">
          <NameCompanyHeader />
          <p className="css-4hzbpn font-['Raleway:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#3c3c3c] text-[14px] w-[150px]">Date</p>
          <p className="css-4hzbpn font-['Raleway:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#3c3c3c] text-[14px] w-[150px]">Time</p>
          <p className="css-4hzbpn font-['Raleway:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#3c3c3c] text-[14px] w-[250px]">Tickets/Registrations</p>
          <p className="css-4hzbpn font-['Raleway:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#3c3c3c] text-[14px] w-[120px]">Status</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="h-[16px] relative shrink-0 w-[51.484px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="capitalize css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#2f6192] text-[12px]">Physical</p>
      </div>
    </div>
  );
}
...
function NameCompanyContainer() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-[500px]" data-name="Name/Company Container">
      <div className="bg-[#e5e5e5] h-[53px] relative rounded-[8px] shrink-0 w-[62px]" data-name="Event Image">
...
function StatusIndicator() {
  return (
    <div className="absolute content-stretch flex gap-[4px] items-center justify-center left-0 px-[11px] py-px rounded-[11px] top-0" data-name="Status Indicator">
...
function StatusContainer() {
  return (
    <div className="h-[22px] relative shrink-0 w-[120px]" data-name="Status Container">
      <StatusIndicator />
    </div>
  );
}
...
function EventList() {
  return (
    <div className="relative shrink-0 w-full" data-name="event list">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[16px] items-center p-[16px] relative w-full">
          ...
          <p className="css-4hzbpn font-['Raleway:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#3c3c3c] text-[14px] w-[150px]">17 June 2025</p>
          <p className="css-4hzbpn font-['Raleway:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#3c3c3c] text-[14px] w-[150px]">9:00 AM WAT</p>
          <p className="css-4hzbpn font-['Raleway:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#3c3c3c] text-[14px] w-[250px]">10</p>
          <StatusContainer />
        </div>
      </div>
    </div>
...
function NameCompanyContainer1() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-[500px]" data-name="Name/Company Container">
      <div className="bg-[#e5e5e5] h-[53px] relative rounded-[8px] shrink-0 w-[62px]" data-name="Event Image">
        <div aria-hidden="true" className="absolute border border-[#d4d4d4] border-solid inset-[-1px] pointer-events-none rounded-[9px]" />
...
function StatusIndicator1() {
  return (
    <div className="absolute content-stretch flex gap-[4px] items-center justify-center left-0 px-[11px] py-px rounded-[11px] top-0" data-name="Status Indicator">
      ...
      <p className="css-ew64yg font-['Raleway:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#239c45] text-[13px]">Draft</p>
    </div>
  );
}
...
function EventList1() {
  return (
    <div className="relative shrink-0 w-full" data-name="event list">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[16px] items-center p-[16px] relative w-full">
          <NameCompanyContainer1 />
          <p className="css-4hzbpn font-['Raleway:Medium','Noto_Sans:Medium',sans-serif] leading-[normal] relative shrink-0 text-[#3c3c3c] text-[14px] w-[150px]" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100, 'wght' 500" }}>
            ₦3000.000
          </p>
          <p className="css-4hzbpn font-['Raleway:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#3c3c3c] text-[14px] w-[150px]">9:00 AM WAT</p>
          <p className="css-4hzbpn font-['Raleway:Medium','Noto_Sans:Medium',sans-serif] leading-[normal] relative shrink-0 text-[#3c3c3c] text-[14px] w-[250px]" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100, 'wght' 500" }}>
            ₦3000.000
          </p>
          <StatusContainer1 />
        </div>
...
function Paragraph2() {
  return (
    <div className="content-stretch flex items-center justify-center overflow-clip relative shrink-0 w-full" data-name="Paragraph">
      <p className="css-ew64yg font-['Raleway:SemiBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#0a0a0a] text-[16px]">Abuja Startup Summit</p>
    </div>
  );
}
...
function Text2() {
  return (
    <div className="h-[16px] relative shrink-0 w-[51.484px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="capitalize css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#2f6192] text-[12px]">Virtual</p>
      </div>
    </div>
  );
}
...
function NameCompanyContainer2() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-[500px]" data-name="Name/Company Container">
      <div className="bg-[#e5e5e5] h-[53px] relative rounded-[8px] shrink-0 w-[62px]" data-name="Event Image">
        <div aria-hidden="true" className="absolute border border-[#d4d4d4] border-solid inset-[-1px] pointer-events-none rounded-[9px]" />
...
function EventList2() {
  return (
    <div className="relative shrink-0 w-full" data-name="event list">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[16px] items-center p-[16px] relative w-full">
          <NameCompanyContainer2 />
          <p className="css-4hzbpn font-['Raleway:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#3c3c3c] text-[14px] w-[150px]">25 September 2025</p>
          <p className="css-4hzbpn font-['Raleway:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#3c3c3c] text-[14px] w-[150px]">2:00 PM WAT</p>
          <p className="css-4hzbpn font-['Raleway:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#3c3c3c] text-[14px] w-[250px]">100</p>
          <StatusContainer2 />
        </div>
      </div>
    </div>
...
function Paragraph3() {
  return (
    <div className="content-stretch flex items-center justify-center overflow-clip relative shrink-0 w-full" data-name="Paragraph">
      <p className="css-ew64yg font-['Raleway:SemiBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#0a0a0a] text-[16px]">Port Harcourt Innovation Expo</p>
    </div>
  );
}
...
function Text3() {
  return (
    <div className="h-[16px] relative shrink-0 w-[51.484px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="capitalize css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#2f6192] text-[12px]">Hybrid</p>
      </div>
    </div>
  );
}
...
function NameCompanyContainer3() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-[500px]" data-name="Name/Company Container">
      <div className="bg-[#e5e5e5] h-[53px] relative rounded-[8px] shrink-0 w-[62px]" data-name="Event Image">
        <div aria-hidden="true" className="absolute border border-[#d4d4d4] border-solid inset-[-1px] pointer-events-none rounded-[9px]" />
...
function EventList3() {
  return (
    <div className="relative shrink-0 w-full" data-name="event list">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[16px] items-center p-[16px] relative w-full">
          <NameCompanyContainer3 />
          <p className="css-4hzbpn font-['Raleway:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#3c3c3c] text-[14px] w-[150px]">12 November 2025</p>
          <p className="css-4hzbpn font-['Raleway:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#3c3c3c] text-[14px] w-[150px]">10:00 AM WAT</p>
          <p className="css-4hzbpn font-['Raleway:Medium','Noto_Sans:Medium',sans-serif] leading-[normal] relative shrink-0 text-[#3c3c3c] text-[14px] w-[250px]" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100, 'wght' 500" }}>
            ₦5000.000
          </p>
          <StatusContainer3 />
...
function AppListItems() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="App List Items">
      <EventList />
      <EventList1 />
      <EventList2 />
      <EventList3 />
...
function AppListSection() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full" data-name="App List Section">
      <AppListHeader />
      <AppListItems />
    </div>
  );
...
function AppList() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[32px] h-[257px] items-start left-1/2 p-[16px] rounded-[16px] shadow-[0px_100px_28px_0px_rgba(212,212,212,0),0px_64px_26px_0px_rgba(212,212,212,0.01)] top-[208px] translate-x-[-50%] w-[1280px]" data-name="App List">
      <AppListSection />
    </div>
  );
}
...
export default function ListView() {
  return (
    <div className="bg-gradient-to-r from-white relative size-full to-white" data-name="List view">
      <Header />
      <Header1 />
      <AppList />
    </div>
